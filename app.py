...
def player_page(team_name, player_name):
    ...
    # calculate cumulative stats for display
    cumulative_goals = 0
...
# Add admin routes, approve/deny requests, delete lineup request, etc. similar to before
# ... (same as previous code, just delete must be a request)
